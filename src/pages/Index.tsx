            ...
            {auth.isAuthenticated ? (
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-2 sm:gap-3 text-sm bg-card border rounded-full px-2 sm:px-4 py-1.5 sm:py-2">
                  ...
                  <span className="font-medium text-xs sm:text-sm hidden xs:block max-w-[80px] sm:max-w-none truncate">
                    {auth.user?.name}
                  </span>
                </div>
                <Button
              ...
              {boards.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Crie seu primeiro quadro ou entre em um existente usando um
                    código
                  </p>
          ...
          <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-12">
            <div className="text-center space-y-6 max-w-2xl">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Organize suas tarefas, colabore com sua equipe e mantenha-se
                produtivo.
              </p>
            </div>
