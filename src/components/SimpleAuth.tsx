...
export const SimpleAuth = ({ open, onOpenChange }: SimpleAuthProps) => {
  ...
  return (
    <div
      className="fixed top-0 left-0 right-0 bottom-0 z-50 bg-gradient-to-br from-primary/20 via-background to-primary/10"
      style={{
        width: "100vw",
        height: "100vh",
        margin: 0,
        ...
        <div className="w-full h-full flex items-center justify-center p-0 sm:p-6 md:p-8">
          ...
          <div className="w-full h-full sm:w-[480px] sm:h-[600px] md:w-[520px] md:h-[650px] lg:w-[600px] lg:h-[700px] xl:w-[650px] xl:h-[750px] bg-transparent sm:bg-card/80 backdrop-blur-xl sm:border sm:border-border/50 sm:rounded-3xl sm:shadow-2xl p-6 sm:p-6 md:p-8 lg:p-10 flex flex-col justify-center relative px-[12px]">
            ...
            <Button
              ...
              className="absolute top-4 left-4 z-10 w-10 h-10 rounded-full hover:bg-background/10 text-foreground/60 hover:text-foreground/80 transition-all duration-200 touch-manipulation flex items-center justify-center mx-0 px-0 text-base my-0"
            >
            ...
            <div className="flex-1 flex flex-col justify-center min-h-0 px-0 sm:px-0 w-full">
              <form
                ...
                className="space-y-5 sm:space-y-4 md:space-y-5 flex flex-col justify-center h-full w-full"
              >
                ...
                <div className="space-y-6 sm:space-y-4 md:space-y-5 flex-1 flex flex-col justify-center w-full">
                  {!isLogin && (
                    <div className="space-y-3 w-full">
                      <Label
                        htmlFor="name"
                        className="text-lg sm:text-sm md:text-base font-medium text-foreground/80"
                      >
                        Nome completo
                      </Label>
                      <Input
                        ...
                        className="w-full h-16 sm:h-12 md:h-14 lg:h-16 text-xl sm:text-base md:text-base lg:text-lg border-2 border-border/50 bg-background/80 backdrop-blur-sm focus:border-primary/50 focus:bg-background rounded-xl touch-manipulation px-6 sm:px-4"
                        autoComplete="name"
                        required
                      />
                    </div>
                  ...
                  {isLogin && (
                    <div className="hidden sm:block h-0 sm:h-[72px] md:h-[86px] lg:h-[98px]"></div>
                  )}
                </div>
                ...
                <div className="space-y-4 sm:space-y-4 md:space-y-5 flex-shrink-0 w-full">
                  <Button
                    type="submit"
                    className="w-full h-14 sm:h-12 md:h-14 lg:h-16 text-lg sm:text-base md:text-base lg:text-lg bg-gradient-primary hover:shadow-xl text-white font-semibold rounded-xl touch-manipulation"
                  >
                  ...
                  <div className="text-center w-full">
                    <button
                      type="button"
                      onClick={toggleMode}
                      className="text-base sm:text-sm md:text-base text-muted-foreground hover:text-primary touch-manipulation py-3 sm:py-2 w-full"
                    >
                      {isLogin
                  ...
                  {isLogin ? (
                    <div className="w-full text-base sm:text-sm md:text-base text-muted-foreground p-4 sm:p-3 md:p-4 bg-gradient-to-r from-muted/40 to-muted/20 rounded-xl border border-border/30 backdrop-blur-sm">
                    ...
                    <div className="hidden sm:block h-0 sm:h-[50px] md:h-[58px]"></div>
                  )}
                </div>
              </form>
            </div>
