            ...
            <div className="relative">
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-full pl-12 pr-4 h-14 text-base font-medium bg-card/80 backdrop-blur-md border-2 border-border/40 rounded-xl placeholder:text-muted-foreground/50 text-foreground"
                />
              </div>
            </div>
          </div>
